...
void vector_swap(vector<int> &v1,vector<int> &v2,int start1, int end1,int start2, int end2){
    vector<int> tmp12(v1.begin()+start1,v1.begin()+end1);
    vector<int> tmp21(v2.begin()+start2,v2.begin()+end2);
    v1.erase(v1.begin()+start1,v1.begin()+end1);
    v1.insert(v1.begin()+start1,tmp21.begin(),tmp21.end());
    v2.erase(v2.begin()+start2,v2.begin()+end2);
    v2.insert(v2.begin()+start2,tmp12.begin(),tmp12.end());
}
