#ifndef CP_UNORDERED_MAP
#define CP_UNORDERED_MAP
...
namespace CP{
    ...
    class unordered_map{
        ...
        protected:
            ...
            ValueIterator insert_to_bucket(const ValueT& val, size_t& bucketIdx){
                if(load_factor() > max_load_factor()){
                    ...
                    bucketIdx = hash_to_bucket(val.first);
                }
                mSize++;
        ...
        public:
            ...
            // default constructor
            unordered_map():mBuckets(std::vector<BucketT>(11)),mSize(0),mHasher(HasherT()),mEqual(EqualT()),mMaxLoadFactor(1.0){}

            // copy constructor
            unordered_map(const unordered_map<KeyT,MappedT,HasherT,EqualT> & other): mBuckets(other.mBuckets),mSize(other.mSize),
            mHasher(other.mHasher),mEqual(other.mEqual),mMaxLoadFactor(other.mMaxLoadFactor){}
            ...
            MappedT& operator[](const KeyT& key){
                ...
                if( it == mBuckets[bi].end()) it = insert_to_bucket(std::make_pair(key, MappedT()),bi);
                return it->second;
            }
            ...
            std::pair<iterator,bool> insert(const ValueT& val){
                ...
                result.first = iterator(it, mBuckets.begin()+bi, mBuckets.end());
                return result;
            }
